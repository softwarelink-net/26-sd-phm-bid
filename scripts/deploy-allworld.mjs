...
/**
 * Upload dist/ to:
 *   1) R2 26-sd-phm-bid-assets
 *   2) R2 allworld-sites/26-sd-phm-bid/
 */
...
const siteId = process.argv[2] || '26-sd-phm-bid'
const projectBucket = '26-sd-phm-bid-assets'
...
if (!files.length) {
  console.error('dist/ is empty. Run pnpm run build first.')
  process.exit(1)
}
